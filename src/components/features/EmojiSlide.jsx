    ...
    <div className="slide">
        ...
        >
            ...
            <div style={{ textAlign: 'center' }}>
                ...
                <h2 style={{ fontSize: '3rem', marginBottom: '0.5rem' }}>The Vibe</h2>
                        ...
                        {topEmojis.length > 0 ? topEmojis.map((e, i) => (
                             <motion.div 
                                ...
                                style={{ 
                                 ...
                                 <span style={{ fontSize: i === 0 ? '5rem' : '3rem', lineHeight: 1 }}>{e.item}</span>
                ...
                <div>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                        {Object.keys(topEmojisPerSender).slice(0, 2).map((sender, idx) => {
                             ...
                             return (
                                 <div key={sender} style={{ background: 'rgba(255,255,255,0.05)', padding: '1.5rem', borderRadius: '24px' }}>
                                     <div style={{ fontSize: '1.2rem', fontWeight: 'bold', marginBottom: '1rem', color: idx === 0 ? 'var(--accent-color)' : '#38bdf8' }}>
                                         {sender}'s Mood
                                     </div>
                                     <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
                                         {tops.map((t, i) => (
                                             <div key={t.item} style={{ 
                                                 ...
                                                 <span style={{ fontSize: '2rem', lineHeight: 1 }}>{t.item}</span>
